...
namespace _07_RepositoryPattern_Tests
{
    ...
    public class StreamingContentTests
    {
        ...
        public void StreamingContentNotes()
        {
            ...
            Movie newMovie = new Movie("Venom", "The best romance", 9005, MaturityRating.PG_13, true, GenreType.RomCom, 132);
        }
        ...
        [DataRow(MaturityRating.MA, true)]

        public void SetMaturityRating_ShouldGetCorrectBool(MaturityRating rating, bool isFamilyFriendly)
        {
            StreamingContent content = new StreamingContent("Instert Title Here", "Description here", 5, rating, true, GenreType.Documentary);
